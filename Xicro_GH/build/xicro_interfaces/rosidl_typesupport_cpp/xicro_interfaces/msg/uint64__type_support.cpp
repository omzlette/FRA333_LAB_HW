...
static const _Uint64_type_support_symbol_names_t _Uint64_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xicro_interfaces, msg, Uint64)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xicro_interfaces, msg, Uint64)),
  }
};
...
get_message_type_support_handle<xicro_interfaces::msg::Uint64>()
{
  return &::xicro_interfaces::msg::rosidl_typesupport_cpp::Uint64_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xicro_interfaces, msg, Uint64)() {
  return get_message_type_support_handle<xicro_interfaces::msg::Uint64>();
}
