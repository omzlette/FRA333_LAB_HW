...
bool xicro_interfaces__msg__time__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xicro_interfaces.msg._time.Time", full_classname_dest, 31) == 0);
  }
  xicro_interfaces__msg__Time * ros_message = _ros_message;
  {  // sec
...
PyObject * xicro_interfaces__msg__time__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("xicro_interfaces.msg._time");
