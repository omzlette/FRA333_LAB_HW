...
{
  new (message_memory) xicro_interfaces::msg::Uint64(_init);
}

void Uint64_fini_function(void * message_memory)
{
  auto typed_message = static_cast<xicro_interfaces::msg::Uint64 *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Uint64_message_member_array[1] = {
  {
    ...
    offsetof(xicro_interfaces::msg::Uint64, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Uint64_message_members = {
  ...
  "Uint64",  // message name
  1,  // number of fields
  sizeof(xicro_interfaces::msg::Uint64),
...
{
  return &::xicro_interfaces::msg::rosidl_typesupport_introspection_cpp::Uint64_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xicro_interfaces, msg, Uint64)() {
  return &::xicro_interfaces::msg::rosidl_typesupport_introspection_cpp::Uint64_message_type_support_handle;
}
