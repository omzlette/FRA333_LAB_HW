...
{
  new (message_memory) xicro_interfaces::msg::Time(_init);
}

void Time_fini_function(void * message_memory)
{
  auto typed_message = static_cast<xicro_interfaces::msg::Time *>(message_memory);
  typed_message->~Time();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Time_message_member_array[2] = {
  {
    ...
    offsetof(xicro_interfaces::msg::Time, sec),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xicro_interfaces::msg::Time, nanosec),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Time_message_members = {
  ...
  "Time",  // message name
  2,  // number of fields
  sizeof(xicro_interfaces::msg::Time),
...
{
  return &::xicro_interfaces::msg::rosidl_typesupport_introspection_cpp::Time_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xicro_interfaces, msg, Time)() {
  return &::xicro_interfaces::msg::rosidl_typesupport_introspection_cpp::Time_message_type_support_handle;
}
