...
#include "xicro_interfaces/msg/detail/bool__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const xicro_interfaces::msg::Bool & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xicro_interfaces::msg::Bool & ros_message)
{
  // Member: data
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const xicro_interfaces::msg::Bool *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xicro_interfaces::msg::Bool *>(
    untyped_ros_message);
...
{
  return &xicro_interfaces::msg::typesupport_fastrtps_cpp::_Bool__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xicro_interfaces, msg, Bool)() {
  return &xicro_interfaces::msg::typesupport_fastrtps_cpp::_Bool__handle;
}
