...
#include "xicro_interfaces/msg/detail/pose2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const xicro_interfaces::msg::Pose2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xicro_interfaces::msg::Pose2D & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
{
  auto typed_message =
    static_cast<const xicro_interfaces::msg::Pose2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xicro_interfaces::msg::Pose2D *>(
    untyped_ros_message);
...
{
  return &xicro_interfaces::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xicro_interfaces, msg, Pose2D)() {
  return &xicro_interfaces::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
