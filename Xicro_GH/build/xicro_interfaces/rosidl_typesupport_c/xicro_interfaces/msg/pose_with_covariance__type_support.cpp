...
static const _PoseWithCovariance_type_support_symbol_names_t _PoseWithCovariance_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xicro_interfaces, msg, PoseWithCovariance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xicro_interfaces, msg, PoseWithCovariance)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xicro_interfaces, msg, PoseWithCovariance)() {
  return &::xicro_interfaces::msg::rosidl_typesupport_c::PoseWithCovariance_message_type_support_handle;
}
