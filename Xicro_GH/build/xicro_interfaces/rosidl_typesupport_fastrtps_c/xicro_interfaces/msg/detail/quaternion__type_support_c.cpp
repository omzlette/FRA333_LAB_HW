...
#include "xicro_interfaces/msg/detail/quaternion__rosidl_typesupport_fastrtps_c.h"
...
using _Quaternion__ros_msg_type = xicro_interfaces__msg__Quaternion;
...
static uint32_t _Quaternion__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xicro_interfaces__msg__Quaternion(
...
{
  return max_serialized_size_xicro_interfaces__msg__Quaternion(
    full_bounded, 0);
}
