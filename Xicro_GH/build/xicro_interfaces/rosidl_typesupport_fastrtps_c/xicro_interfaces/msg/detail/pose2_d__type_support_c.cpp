...
#include "xicro_interfaces/msg/detail/pose2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Pose2D__ros_msg_type = xicro_interfaces__msg__Pose2D;
...
size_t get_serialized_size_xicro_interfaces__msg__Pose2D(
  const void * untyped_ros_message,
...
static uint32_t _Pose2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xicro_interfaces__msg__Pose2D(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xicro_interfaces
size_t max_serialized_size_xicro_interfaces__msg__Pose2D(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_xicro_interfaces__msg__Pose2D(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xicro_interfaces, msg, Pose2D)() {
