  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  xicro_interfaces__msg__Vector3__init(message_memory);
}

void Vector3__rosidl_typesupport_introspection_c__Vector3_fini_function(void * message_memory)
{
  xicro_interfaces__msg__Vector3__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Vector3__rosidl_typesupport_introspection_c__Vector3_message_member_array[3] = {
  {
    ...
    offsetof(xicro_interfaces__msg__Vector3, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xicro_interfaces__msg__Vector3, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xicro_interfaces__msg__Vector3, z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Vector3__rosidl_typesupport_introspection_c__Vector3_message_members = {
  ...
  3,  // number of fields
  sizeof(xicro_interfaces__msg__Vector3),
