...
static const _GetPosition_Request_type_support_symbol_names_t _GetPosition_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sandevistan_kinematics_interfaces, srv, GetPosition_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sandevistan_kinematics_interfaces, srv, GetPosition_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sandevistan_kinematics_interfaces, srv, GetPosition_Request)() {
  return &::sandevistan_kinematics_interfaces::srv::rosidl_typesupport_c::GetPosition_Request_message_type_support_handle;
}
...
static const _GetPosition_Response_type_support_symbol_names_t _GetPosition_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sandevistan_kinematics_interfaces, srv, GetPosition_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sandevistan_kinematics_interfaces, srv, GetPosition_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_sandevistan_kinematics_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sandevistan_kinematics_interfaces, srv, GetPosition_Response)() {
  return &::sandevistan_kinematics_interfaces::srv::rosidl_typesupport_c::GetPosition_Response_message_type_support_handle;
}
...
static const _GetPosition_type_support_symbol_names_t _GetPosition_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sandevistan_kinematics_interfaces, srv, GetPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sandevistan_kinematics_interfaces, srv, GetPosition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, sandevistan_kinematics_interfaces, srv, GetPosition)() {
  return &::sandevistan_kinematics_interfaces::srv::rosidl_typesupport_c::GetPosition_service_type_support_handle;
}
