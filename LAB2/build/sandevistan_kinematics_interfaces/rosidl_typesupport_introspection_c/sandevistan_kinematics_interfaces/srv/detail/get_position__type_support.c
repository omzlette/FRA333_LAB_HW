...
#include <stddef.h>
#include "sandevistan_kinematics_interfaces/srv/detail/get_position__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  sandevistan_kinematics_interfaces__srv__GetPosition_Request__init(message_memory);
}

void GetPosition_Request__rosidl_typesupport_introspection_c__GetPosition_Request_fini_function(void * message_memory)
{
  sandevistan_kinematics_interfaces__srv__GetPosition_Request__fini(message_memory);
}
...
static const rosidl_typesupport_introspection_c__MessageMembers GetPosition_Request__rosidl_typesupport_introspection_c__GetPosition_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(sandevistan_kinematics_interfaces__srv__GetPosition_Request),
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  sandevistan_kinematics_interfaces__srv__GetPosition_Response__init(message_memory);
}

void GetPosition_Response__rosidl_typesupport_introspection_c__GetPosition_Response_fini_function(void * message_memory)
{
  sandevistan_kinematics_interfaces__srv__GetPosition_Response__fini(message_memory);
}
...
static const rosidl_typesupport_introspection_c__MessageMembers GetPosition_Response__rosidl_typesupport_introspection_c__GetPosition_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(sandevistan_kinematics_interfaces__srv__GetPosition_Response),
...
static rosidl_typesupport_introspection_c__ServiceMembers sandevistan_kinematics_interfaces__srv__detail__get_position__rosidl_typesupport_introspection_c__GetPosition_service_members = {
  "sandevistan_kinematics_interfaces__srv",  // service namespace
  "GetPosition",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // sandevistan_kinematics_interfaces__srv__detail__get_position__rosidl_typesupport_introspection_c__GetPosition_Request_message_type_support_handle,
  NULL  // response message
  // sandevistan_kinematics_interfaces__srv__detail__get_position__rosidl_typesupport_introspection_c__GetPosition_Response_message_type_support_handle
};

static rosidl_service_type_support_t sandevistan_kinematics_interfaces__srv__detail__get_position__rosidl_typesupport_introspection_c__GetPosition_service_type_support_handle = {
  0,
  &sandevistan_kinematics_interfaces__srv__detail__get_position__rosidl_typesupport_introspection_c__GetPosition_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sandevistan_kinematics_interfaces, srv, GetPosition)() {
  if (!sandevistan_kinematics_interfaces__srv__detail__get_position__rosidl_typesupport_introspection_c__GetPosition_service_type_support_handle.typesupport_identifier) {
    sandevistan_kinematics_interfaces__srv__detail__get_position__rosidl_typesupport_introspection_c__GetPosition_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)sandevistan_kinematics_interfaces__srv__detail__get_position__rosidl_typesupport_introspection_c__GetPosition_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sandevistan_kinematics_interfaces, srv, GetPosition_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sandevistan_kinematics_interfaces, srv, GetPosition_Response)()->data;
  }

  return &sandevistan_kinematics_interfaces__srv__detail__get_position__rosidl_typesupport_introspection_c__GetPosition_service_type_support_handle;
}
