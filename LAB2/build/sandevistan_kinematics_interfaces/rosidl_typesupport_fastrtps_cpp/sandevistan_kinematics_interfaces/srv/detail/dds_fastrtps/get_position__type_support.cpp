...
#include "sandevistan_kinematics_interfaces/srv/detail/get_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sandevistan_kinematics_interfaces::srv::GetPosition_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sandevistan_kinematics_interfaces::srv::GetPosition_Request & ros_message)
{
  // Member: joint
...
{
  auto typed_message =
    static_cast<const sandevistan_kinematics_interfaces::srv::GetPosition_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sandevistan_kinematics_interfaces::srv::GetPosition_Request *>(
    untyped_ros_message);
...
{
  return &sandevistan_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_GetPosition_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sandevistan_kinematics_interfaces, srv, GetPosition_Request)() {
  return &sandevistan_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_GetPosition_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sandevistan_kinematics_interfaces
cdr_serialize(
  const sandevistan_kinematics_interfaces::srv::GetPosition_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: position
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sandevistan_kinematics_interfaces::srv::GetPosition_Response & ros_message)
{
  // Member: position
...
{
  auto typed_message =
    static_cast<const sandevistan_kinematics_interfaces::srv::GetPosition_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<sandevistan_kinematics_interfaces::srv::GetPosition_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &sandevistan_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_GetPosition_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sandevistan_kinematics_interfaces, srv, GetPosition_Response)() {
  return &sandevistan_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_GetPosition_Response__handle;
}
...
{
  return &sandevistan_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_GetPosition__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sandevistan_kinematics_interfaces, srv, GetPosition)() {
  return &sandevistan_kinematics_interfaces::srv::typesupport_fastrtps_cpp::_GetPosition__handle;
}
