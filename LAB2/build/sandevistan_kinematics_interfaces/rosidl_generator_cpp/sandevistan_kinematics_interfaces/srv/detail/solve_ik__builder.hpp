...
{
  return ::sandevistan_kinematics_interfaces::srv::SolveIK_Request(rosidl_runtime_cpp::MessageInitialization::ZERO);
}
...
{
  return ::sandevistan_kinematics_interfaces::srv::SolveIK_Response(rosidl_runtime_cpp::MessageInitialization::ZERO);
}
