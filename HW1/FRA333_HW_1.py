    ...
    def trackBeeBot(self, com, W):
        ...
        for i in com:
            if i == '1':
                ...
                stepMatrix = np.matmul(self.rotateMatL(self.theta), stepMatrix)
                print("left")
            elif i == '4':
                stepMatrix = np.matmul(self.rotateMatR(self.theta), stepMatrix)
                print("right")
            # else:
...
A = testBot.trackBeeBot('10004031304133412113203401202434122434340313312420340143230302444311410144134242324403414413032441433', [])
print(A)