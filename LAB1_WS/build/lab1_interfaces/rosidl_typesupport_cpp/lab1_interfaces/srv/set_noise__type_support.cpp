...
static const _SetNoise_Request_type_support_symbol_names_t _SetNoise_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lab1_interfaces, srv, SetNoise_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lab1_interfaces, srv, SetNoise_Request)),
  }
};
...
{
  return &::lab1_interfaces::srv::rosidl_typesupport_cpp::SetNoise_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lab1_interfaces, srv, SetNoise_Request)() {
  return get_message_type_support_handle<lab1_interfaces::srv::SetNoise_Request>();
}
...
static const _SetNoise_Response_type_support_symbol_names_t _SetNoise_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lab1_interfaces, srv, SetNoise_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lab1_interfaces, srv, SetNoise_Response)),
  }
};
...
{
  return &::lab1_interfaces::srv::rosidl_typesupport_cpp::SetNoise_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lab1_interfaces, srv, SetNoise_Response)() {
  return get_message_type_support_handle<lab1_interfaces::srv::SetNoise_Response>();
}
...
static const _SetNoise_type_support_symbol_names_t _SetNoise_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lab1_interfaces, srv, SetNoise)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lab1_interfaces, srv, SetNoise)),
  }
};
...
{
  return &::lab1_interfaces::srv::rosidl_typesupport_cpp::SetNoise_service_type_support_handle;
}
