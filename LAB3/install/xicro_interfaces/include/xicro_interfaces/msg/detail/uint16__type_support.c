...
#include <stddef.h>
#include "xicro_interfaces/msg/detail/uint16__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  xicro_interfaces__msg__Uint16__init(message_memory);
}

void Uint16__rosidl_typesupport_introspection_c__Uint16_fini_function(void * message_memory)
{
  xicro_interfaces__msg__Uint16__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Uint16__rosidl_typesupport_introspection_c__Uint16_message_member_array[1] = {
  {
    ...
    offsetof(xicro_interfaces__msg__Uint16, data),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Uint16__rosidl_typesupport_introspection_c__Uint16_message_members = {
  ...
  "Uint16",  // message name
  1,  // number of fields
  sizeof(xicro_interfaces__msg__Uint16),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xicro_interfaces, msg, Uint16)() {
