...
{
  new (message_memory) xicro_interfaces::msg::Int8(_init);
}

void Int8_fini_function(void * message_memory)
{
  auto typed_message = static_cast<xicro_interfaces::msg::Int8 *>(message_memory);
  typed_message->~Int8();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Int8_message_member_array[1] = {
  {
    ...
    offsetof(xicro_interfaces::msg::Int8, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Int8_message_members = {
  ...
  "Int8",  // message name
  1,  // number of fields
  sizeof(xicro_interfaces::msg::Int8),
...
{
  return &::xicro_interfaces::msg::rosidl_typesupport_introspection_cpp::Int8_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xicro_interfaces, msg, Int8)() {
  return &::xicro_interfaces::msg::rosidl_typesupport_introspection_cpp::Int8_message_type_support_handle;
}
