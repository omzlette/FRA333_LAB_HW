...
{
  new (message_memory) xicro_interfaces::msg::Vector3(_init);
}

void Vector3_fini_function(void * message_memory)
{
  auto typed_message = static_cast<xicro_interfaces::msg::Vector3 *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Vector3_message_member_array[3] = {
  {
    ...
    offsetof(xicro_interfaces::msg::Vector3, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xicro_interfaces::msg::Vector3, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xicro_interfaces::msg::Vector3, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Vector3_message_members = {
  ...
  3,  // number of fields
  sizeof(xicro_interfaces::msg::Vector3),
...
{
  return &::xicro_interfaces::msg::rosidl_typesupport_introspection_cpp::Vector3_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xicro_interfaces, msg, Vector3)() {
  return &::xicro_interfaces::msg::rosidl_typesupport_introspection_cpp::Vector3_message_type_support_handle;
}
