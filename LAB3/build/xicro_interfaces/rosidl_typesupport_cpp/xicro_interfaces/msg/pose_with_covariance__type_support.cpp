...
static const _PoseWithCovariance_type_support_symbol_names_t _PoseWithCovariance_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xicro_interfaces, msg, PoseWithCovariance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xicro_interfaces, msg, PoseWithCovariance)),
  }
};
...
{
  return &::xicro_interfaces::msg::rosidl_typesupport_cpp::PoseWithCovariance_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xicro_interfaces, msg, PoseWithCovariance)() {
  return get_message_type_support_handle<xicro_interfaces::msg::PoseWithCovariance>();
}
