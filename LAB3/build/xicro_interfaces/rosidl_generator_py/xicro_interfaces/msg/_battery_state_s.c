...
bool xicro_interfaces__msg__battery_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xicro_interfaces.msg._battery_state.BatteryState", full_classname_dest, 48) == 0);
  }
  xicro_interfaces__msg__BatteryState * ros_message = _ros_message;
  {  // voltage
  ...
  {  // cell_voltage
    ...
    }
    {
      ...
      Py_ssize_t size = 4;
      float * dest = ros_message->cell_voltage;
  ...
  {  // cell_temperature
    ...
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT32);
      Py_ssize_t size = 4;
      float * dest = ros_message->cell_temperature;
      for (Py_ssize_t i = 0; i < size; ++i) {
        float tmp = *(npy_float32 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(float));
      }
...
PyObject * xicro_interfaces__msg__battery_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("xicro_interfaces.msg._battery_state");
  ...
  {  // cell_voltage
    ...
    float * src = &(ros_message->cell_voltage[0]);
  ...
  {  // cell_temperature
    ...
    assert(sizeof(npy_float32) == sizeof(float));
    npy_float32 * dst = (npy_float32 *)PyArray_GETPTR1(seq_field, 0);
    float * src = &(ros_message->cell_temperature[0]);
    memcpy(dst, src, 4 * sizeof(float));
    Py_DECREF(field);
  }
  {  // location
