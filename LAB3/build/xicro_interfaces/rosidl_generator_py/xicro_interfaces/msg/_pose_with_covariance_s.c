...
bool xicro_interfaces__msg__pose_with_covariance__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xicro_interfaces.msg._pose_with_covariance.PoseWithCovariance", full_classname_dest, 61) == 0);
  }
  xicro_interfaces__msg__PoseWithCovariance * ros_message = _ros_message;
  {  // pose
...
PyObject * xicro_interfaces__msg__pose_with_covariance__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("xicro_interfaces.msg._pose_with_covariance");
