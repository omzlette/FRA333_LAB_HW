...
xicro_interfaces__msg__Vector3__create()
{
  ...
  xicro_interfaces__msg__Vector3 * msg = (xicro_interfaces__msg__Vector3 *)allocator.allocate(sizeof(xicro_interfaces__msg__Vector3), allocator.state);
  if (!msg) {
    return NULL;
  }
...
xicro_interfaces__msg__Vector3__Sequence__init(xicro_interfaces__msg__Vector3__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (xicro_interfaces__msg__Vector3 *)allocator.zero_allocate(size, sizeof(xicro_interfaces__msg__Vector3), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__msg__Vector3__Sequence * array = (xicro_interfaces__msg__Vector3__Sequence *)allocator.allocate(sizeof(xicro_interfaces__msg__Vector3__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
xicro_interfaces__msg__Vector3__Sequence__are_equal(const xicro_interfaces__msg__Vector3__Sequence * lhs, const xicro_interfaces__msg__Vector3__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!xicro_interfaces__msg__Vector3__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  xicro_interfaces__msg__Vector3__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(xicro_interfaces__msg__Vector3);
    xicro_interfaces__msg__Vector3 * data =
      (xicro_interfaces__msg__Vector3 *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xicro_interfaces__msg__Vector3__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          xicro_interfaces__msg__Vector3__fini(&data[i]);
        }
        free(data);
        return false;
      }
