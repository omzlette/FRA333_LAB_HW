...
bool
xicro_interfaces__msg__Twist__are_equal(const xicro_interfaces__msg__Twist * lhs, const xicro_interfaces__msg__Twist * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
xicro_interfaces__msg__Twist__copy(
  const xicro_interfaces__msg__Twist * input,
  xicro_interfaces__msg__Twist * output)
{
  if (!input || !output) {
    return false;
  }
...
xicro_interfaces__msg__Twist__create()
{
  ...
  xicro_interfaces__msg__Twist * msg = (xicro_interfaces__msg__Twist *)allocator.allocate(sizeof(xicro_interfaces__msg__Twist), allocator.state);
  if (!msg) {
    return NULL;
  }
...
xicro_interfaces__msg__Twist__Sequence__init(xicro_interfaces__msg__Twist__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (xicro_interfaces__msg__Twist *)allocator.zero_allocate(size, sizeof(xicro_interfaces__msg__Twist), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__msg__Twist__Sequence * array = (xicro_interfaces__msg__Twist__Sequence *)allocator.allocate(sizeof(xicro_interfaces__msg__Twist__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
xicro_interfaces__msg__Twist__Sequence__are_equal(const xicro_interfaces__msg__Twist__Sequence * lhs, const xicro_interfaces__msg__Twist__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!xicro_interfaces__msg__Twist__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
xicro_interfaces__msg__Twist__Sequence__copy(
  const xicro_interfaces__msg__Twist__Sequence * input,
  xicro_interfaces__msg__Twist__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(xicro_interfaces__msg__Twist);
    xicro_interfaces__msg__Twist * data =
      (xicro_interfaces__msg__Twist *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xicro_interfaces__msg__Twist__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          xicro_interfaces__msg__Twist__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!xicro_interfaces__msg__Twist__copy(
