...
bool
xicro_interfaces__msg__Quaternion__are_equal(const xicro_interfaces__msg__Quaternion * lhs, const xicro_interfaces__msg__Quaternion * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
xicro_interfaces__msg__Quaternion__copy(
  const xicro_interfaces__msg__Quaternion * input,
  xicro_interfaces__msg__Quaternion * output)
{
  if (!input || !output) {
    return false;
  }
...
xicro_interfaces__msg__Quaternion__create()
{
  ...
  xicro_interfaces__msg__Quaternion * msg = (xicro_interfaces__msg__Quaternion *)allocator.allocate(sizeof(xicro_interfaces__msg__Quaternion), allocator.state);
  if (!msg) {
    return NULL;
  }
...
xicro_interfaces__msg__Quaternion__Sequence__init(xicro_interfaces__msg__Quaternion__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (xicro_interfaces__msg__Quaternion *)allocator.zero_allocate(size, sizeof(xicro_interfaces__msg__Quaternion), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xicro_interfaces__msg__Quaternion__Sequence * array = (xicro_interfaces__msg__Quaternion__Sequence *)allocator.allocate(sizeof(xicro_interfaces__msg__Quaternion__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
xicro_interfaces__msg__Quaternion__Sequence__are_equal(const xicro_interfaces__msg__Quaternion__Sequence * lhs, const xicro_interfaces__msg__Quaternion__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!xicro_interfaces__msg__Quaternion__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
xicro_interfaces__msg__Quaternion__Sequence__copy(
  const xicro_interfaces__msg__Quaternion__Sequence * input,
  xicro_interfaces__msg__Quaternion__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(xicro_interfaces__msg__Quaternion);
    xicro_interfaces__msg__Quaternion * data =
      (xicro_interfaces__msg__Quaternion *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xicro_interfaces__msg__Quaternion__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          xicro_interfaces__msg__Quaternion__fini(&data[i]);
        }
        free(data);
        return false;
      }
