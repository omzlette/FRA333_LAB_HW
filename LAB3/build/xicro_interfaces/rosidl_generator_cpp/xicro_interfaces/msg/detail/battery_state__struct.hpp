...
#ifndef XICRO_INTERFACES__MSG__DETAIL__BATTERY_STATE__STRUCT_HPP_
#define XICRO_INTERFACES__MSG__DETAIL__BATTERY_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__xicro_interfaces__msg__BatteryState __attribute__((deprecated))
#else
# define DEPRECATED__xicro_interfaces__msg__BatteryState __declspec(deprecated)
#endif
...
struct BatteryState_
{
  ...
  explicit BatteryState_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->present = false;
      std::fill<typename std::array<float, 4>::iterator, float>(this->cell_voltage.begin(), this->cell_voltage.end(), 0.0f);
      std::fill<typename std::array<float, 4>::iterator, float>(this->cell_temperature.begin(), this->cell_temperature.end(), 0.0f);
      this->location = "";
      this->serial_number = "";
    }
  }
  ...
  // pointer types
  using RawPtr =
    xicro_interfaces::msg::BatteryState_<ContainerAllocator> *;
  using ConstRawPtr =
    const xicro_interfaces::msg::BatteryState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<xicro_interfaces::msg::BatteryState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<xicro_interfaces::msg::BatteryState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      xicro_interfaces::msg::BatteryState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<xicro_interfaces::msg::BatteryState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<xicro_interfaces::msg::BatteryState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<xicro_interfaces::msg::BatteryState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<xicro_interfaces::msg::BatteryState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__xicro_interfaces__msg__BatteryState
    std::shared_ptr<xicro_interfaces::msg::BatteryState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__xicro_interfaces__msg__BatteryState
    std::shared_ptr<xicro_interfaces::msg::BatteryState_<ContainerAllocator> const>
...
using BatteryState =
  xicro_interfaces::msg::BatteryState_<std::allocator<void>>;
...
#endif  // XICRO_INTERFACES__MSG__DETAIL__BATTERY_STATE__STRUCT_HPP_
