  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  xicro_interfaces__msg__Time__init(message_memory);
}

void Time__rosidl_typesupport_introspection_c__Time_fini_function(void * message_memory)
{
  xicro_interfaces__msg__Time__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Time__rosidl_typesupport_introspection_c__Time_message_member_array[2] = {
  {
    ...
    offsetof(xicro_interfaces__msg__Time, sec),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xicro_interfaces__msg__Time, nanosec),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Time__rosidl_typesupport_introspection_c__Time_message_members = {
  ...
  "Time",  // message name
  2,  // number of fields
  sizeof(xicro_interfaces__msg__Time),
