...
#include <stddef.h>
#include "xicro_interfaces/msg/detail/pose2_d__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  xicro_interfaces__msg__Pose2D__init(message_memory);
}

void Pose2D__rosidl_typesupport_introspection_c__Pose2D_fini_function(void * message_memory)
{
  xicro_interfaces__msg__Pose2D__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Pose2D__rosidl_typesupport_introspection_c__Pose2D_message_member_array[3] = {
  {
    ...
    offsetof(xicro_interfaces__msg__Pose2D, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xicro_interfaces__msg__Pose2D, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xicro_interfaces__msg__Pose2D, theta),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Pose2D__rosidl_typesupport_introspection_c__Pose2D_message_members = {
  ...
  "Pose2D",  // message name
  3,  // number of fields
  sizeof(xicro_interfaces__msg__Pose2D),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xicro_interfaces, msg, Pose2D)() {
