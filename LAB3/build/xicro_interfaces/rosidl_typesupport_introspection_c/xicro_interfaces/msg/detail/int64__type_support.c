...
#include <stddef.h>
#include "xicro_interfaces/msg/detail/int64__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  xicro_interfaces__msg__Int64__init(message_memory);
}

void Int64__rosidl_typesupport_introspection_c__Int64_fini_function(void * message_memory)
{
  xicro_interfaces__msg__Int64__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Int64__rosidl_typesupport_introspection_c__Int64_message_member_array[1] = {
  {
    ...
    offsetof(xicro_interfaces__msg__Int64, data),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Int64__rosidl_typesupport_introspection_c__Int64_message_members = {
  ...
  "Int64",  // message name
  1,  // number of fields
  sizeof(xicro_interfaces__msg__Int64),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xicro_interfaces, msg, Int64)() {
