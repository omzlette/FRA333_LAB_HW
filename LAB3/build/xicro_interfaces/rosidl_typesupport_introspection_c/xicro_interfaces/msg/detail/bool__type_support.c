...
#include <stddef.h>
#include "xicro_interfaces/msg/detail/bool__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  xicro_interfaces__msg__Bool__init(message_memory);
}

void Bool__rosidl_typesupport_introspection_c__Bool_fini_function(void * message_memory)
{
  xicro_interfaces__msg__Bool__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Bool__rosidl_typesupport_introspection_c__Bool_message_member_array[1] = {
  {
    ...
    offsetof(xicro_interfaces__msg__Bool, data),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Bool__rosidl_typesupport_introspection_c__Bool_message_members = {
  ...
  "Bool",  // message name
  1,  // number of fields
  sizeof(xicro_interfaces__msg__Bool),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xicro_interfaces, msg, Bool)() {
