...
#include "xicro_interfaces/msg/detail/uint16__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const xicro_interfaces::msg::Uint16 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xicro_interfaces::msg::Uint16 *>(
    untyped_ros_message);
...
{
  return &xicro_interfaces::msg::typesupport_fastrtps_cpp::_Uint16__handle;
}
