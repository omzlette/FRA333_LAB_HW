...
#include "xicro_interfaces/msg/detail/uint64__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const xicro_interfaces::msg::Uint64 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xicro_interfaces::msg::Uint64 & ros_message)
{
  // Member: data
  cdr >> ros_message.data;
...
{
  auto typed_message =
    static_cast<const xicro_interfaces::msg::Uint64 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xicro_interfaces::msg::Uint64 *>(
    untyped_ros_message);
...
{
  return &xicro_interfaces::msg::typesupport_fastrtps_cpp::_Uint64__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xicro_interfaces, msg, Uint64)() {
  return &xicro_interfaces::msg::typesupport_fastrtps_cpp::_Uint64__handle;
}
