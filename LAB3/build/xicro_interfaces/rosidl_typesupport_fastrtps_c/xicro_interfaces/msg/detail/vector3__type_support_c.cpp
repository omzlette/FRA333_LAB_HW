...
#include "xicro_interfaces/msg/detail/vector3__rosidl_typesupport_fastrtps_c.h"
...
using _Vector3__ros_msg_type = xicro_interfaces__msg__Vector3;
...
static uint32_t _Vector3__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xicro_interfaces__msg__Vector3(
...
{
  return max_serialized_size_xicro_interfaces__msg__Vector3(
    full_bounded, 0);
}
