...
#include "xicro_interfaces/msg/detail/int64__rosidl_typesupport_fastrtps_c.h"
...
using _Int64__ros_msg_type = xicro_interfaces__msg__Int64;
...
size_t get_serialized_size_xicro_interfaces__msg__Int64(
  const void * untyped_ros_message,
...
static uint32_t _Int64__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xicro_interfaces__msg__Int64(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xicro_interfaces
size_t max_serialized_size_xicro_interfaces__msg__Int64(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_xicro_interfaces__msg__Int64(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xicro_interfaces, msg, Int64)() {
