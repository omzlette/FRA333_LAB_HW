...
#include "xicro_interfaces/msg/detail/header__rosidl_typesupport_fastrtps_c.h"
...
#include "xicro_interfaces/msg/detail/time__functions.h"  // stamp
...
using _Header__ros_msg_type = xicro_interfaces__msg__Header;
  ...
  // Field name: stamp
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, xicro_interfaces, msg, Time
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_xicro_interfaces__msg__Time(
...
static uint32_t _Header__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xicro_interfaces__msg__Header(
  ...
  size_t current_alignment)
{
  ...
  // member: stamp
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_xicro_interfaces__msg__Time(
...
{
  return max_serialized_size_xicro_interfaces__msg__Header(
    full_bounded, 0);
}
