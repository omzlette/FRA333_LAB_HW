...
{
  new (message_memory) xicro_interfaces::msg::Bool(_init);
}

void Bool_fini_function(void * message_memory)
{
  auto typed_message = static_cast<xicro_interfaces::msg::Bool *>(message_memory);
  typed_message->~Bool();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Bool_message_member_array[1] = {
  {
    ...
    offsetof(xicro_interfaces::msg::Bool, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Bool_message_members = {
  ...
  "Bool",  // message name
  1,  // number of fields
  sizeof(xicro_interfaces::msg::Bool),
...
{
  return &::xicro_interfaces::msg::rosidl_typesupport_introspection_cpp::Bool_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xicro_interfaces, msg, Bool)() {
  return &::xicro_interfaces::msg::rosidl_typesupport_introspection_cpp::Bool_message_type_support_handle;
}
