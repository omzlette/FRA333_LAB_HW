...
bool sandevistan_interface__msg__imu_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sandevistan_interface.msg._imu_message.IMUMessage", full_classname_dest, 49) == 0);
  }
  sandevistan_interface__msg__IMUMessage * ros_message = _ros_message;
  {  // linear_acceleration
...
{
  /* NOTE(esteve): Call constructor of IMUMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sandevistan_interface.msg._imu_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IMUMessage");
