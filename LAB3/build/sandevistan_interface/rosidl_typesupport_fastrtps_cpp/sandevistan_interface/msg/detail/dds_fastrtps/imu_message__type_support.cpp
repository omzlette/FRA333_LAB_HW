...
#include "sandevistan_interface/msg/detail/imu_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const sandevistan_interface::msg::IMUMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sandevistan_interface::msg::IMUMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _IMUMessage__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sandevistan_interface::msg::IMUMessage *>(
...
{
  return max_serialized_size_IMUMessage(full_bounded, 0);
}

static message_type_support_callbacks_t _IMUMessage__callbacks = {
...
static rosidl_message_type_support_t _IMUMessage__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_IMUMessage__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_sandevistan_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<sandevistan_interface::msg::IMUMessage>()
{
  return &sandevistan_interface::msg::typesupport_fastrtps_cpp::_IMUMessage__handle;
}
