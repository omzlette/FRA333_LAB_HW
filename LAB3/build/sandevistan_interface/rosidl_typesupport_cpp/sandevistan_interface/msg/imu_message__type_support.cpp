...
static const _IMUMessage_type_support_symbol_names_t _IMUMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sandevistan_interface, msg, IMUMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sandevistan_interface, msg, IMUMessage)),
  }
};
...
{
  return &::sandevistan_interface::msg::rosidl_typesupport_cpp::IMUMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sandevistan_interface, msg, IMUMessage)() {
  return get_message_type_support_handle<sandevistan_interface::msg::IMUMessage>();
}
