...
void Xicro::Test(){
    ...
    _Sendcontinue();
    _SendFloat32(orientation_covariance,9);
    _Sendcontinue();
    ...
    _Sendcontinue();
    _SendFloat32(angular_velocity_covariance,9);
    _Sendcontinue();
    ...
    _Sendcontinue();
    _SendFloat32(linear_acceleration_covariance,9);
    _Sendstop();
    _Sendcrc();}
